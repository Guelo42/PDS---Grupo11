...
carpeta = "tp1/datos/muestrasMiguel"
...
ecg_signal = data  # Señal ECG

# Graficar la forma de onda ECG
plt.figure(figsize=(10, 4))
plt.plot(t, ecg_signal, label='Forma de onda audio')
plt.xlabel('Tiempo (s)')
plt.ylabel('Amplitud')
plt.title('Forma de onda audio')
plt.legend()
plt.grid(True)
plt.show()
...
fft_signal = np.fft.fft(ecg_signal)  # FFT de la señal
